...
export default function Cart() {
  ...
  return (
    <>
      <div
        className={`bg-white top-14 right-auto p-4 h-auto w-96 rounded-lg transition-all duration-300 drop-shadow-md fixed z-50 overflow-y-scroll dark:bg-secondary-dark-bg ${
          isClicked.chat ? `md:right-96 ` : `md:right-20 `
        }`}
      >
        <div className="flex justify-between dark:text-white text-slate-900">
          <div>
        ...
        <div className="flex bottom-0 mt-4 bg-white dark:bg-secondary-dark-bg dark:text-white text-slate-900 items-center">
          <input
            value={query}
